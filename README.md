...
## Estado
Definición inicial y dirección visual aprobada. Este repositorio todavía no contiene una aplicación ejecutable.
Destino previsto: https://trama.jrgblanco.com (no desplegado ni configurado por esta entrega).
La aprobación visual no implica que las miniaturas o los rótulos de las imágenes sean datos reales.
...
Incorporar una carpeta local de prueba, ver previews reales, buscar, guardar una selección persistente y obtener los originales. Reiniciar debe conservar el trabajo.
